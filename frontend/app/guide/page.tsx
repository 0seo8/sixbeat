...
function QuickStartGuide() {
  const steps = [
    ...
    },
    {
      ...
      details: ["MV 끝까지 시청", "좋아요와 댓글 남기기", "공유를 통한 확산"],
      time: "10분/일",
      difficulty: "easy",
    },
    {
  ...
  const faqs = [
    {
      ...
      answer:
        "정해진 시간은 없지만, 자연스럽게 음악을 들으시는 패턴으로 하루에 1-2시간 정도면 충분합니다. 무리하지 마세요!",
    },
    {
      question: "Q. 여러 플랫폼을 모두 사용해야 하나요?",
      answer:
        "모든 플랫폼을 사용할 필요는 없습니다. 본인이 주로 사용하는 1-2개 플랫폼에서 꾸준히 스트리밍하시는 것이 더 효과적입니다.",
    },
    {
      question: "Q. 투표는 언제 하는 것이 가장 좋나요?",
      answer:
        "투표 시작 직후와 마감 직전이 중요합니다. 하지만 매일 꾸준히 하는 것이 가장 중요해요.",
    },
    {
      question: "Q. 무료 이용권으로도 스트리밍이 가능한가요?",
      answer:
        "무료 이용권으로도 가능하지만, 광고나 재생 제한이 있을 수 있습니다. 가능하면 월 이용권을 추천합니다.",
    },
    {
      question: "Q. 해외에서도 스트리밍이 차트에 반영되나요?",
      answer:
        "대부분의 한국 음원 사이트는 국내 IP만 인정합니다. 해외에 계신다면 YouTube 스트리밍에 집중하세요.",
    },
  ];
        ...
        <div className="p-6 md:p-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              여러분의 작은 참여가 모여 DAY6의 큰 성과를 만듭니다.
              <br />
